          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-blue-200">
             ...
             <div className="bg-blue-950 p-4 rounded-xl border border-blue-800 shadow-md">
               ...
               <ul className="space-y-2.5">
                 ...
                 <li className="flex justify-between items-center"><span>Empate</span> <span className="font-black text-blue-400 bg-blue-500/10 px-2 py-0.5 rounded border border-blue-500/20">+3 pt</span></li>
